...
A preview introduction (JP/EN)
A preliminary volume index (Preview only)
A safe, non-technical overview of RLMT prior to zenodo and preprint-server publication
All technical details, equations, and specifications will be added after the official zenodo and preprint-server release.
